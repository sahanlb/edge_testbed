...
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { ddr_r_ready }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { ddr_w_ready }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]

## RGB LEDs
set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { mig_calib_done }]; #IO_L5P_T0_D06_14 Sch=led16_b
